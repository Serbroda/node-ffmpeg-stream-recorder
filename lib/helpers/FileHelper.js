...
exports.deleteFolderRecursive = exports.mergeFiles = exports.findFiles = void 0;
...
exports.findFiles = function (rootDirectory, pattern) {
    ...
    if (pattern) {
        return files
            .filter(function (f) { return !fs.statSync(path_1.join(rootDirectory, f)).isDirectory() && pattern.test(f); })
