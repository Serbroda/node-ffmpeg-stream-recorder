        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    recorder = new Recorder_1.Recorder(process.argv[2], {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, ThreadingHelper_1.sleepAsync(5000)];
                case 2:
                    _a.sent();
                    recorder.pause();
                    console.log('Paused');
                    return [4 /*yield*/, ThreadingHelper_1.sleepAsync(2000)];
                case 3:
                    _a.sent();
                ...
                case 5:
                    ...
                    recorder.stop('C:\\tmp\\chat\\outputtest_' + UniqueHelper_1.createUnique() + '.mp4');
                    console.log('DONE!!');
                    return [4 /*yield*/, ThreadingHelper_1.sleepAsync(2000)];
                case 6:
                    _a.sent();
                    recorder.start();
                    return [4 /*yield*/, ThreadingHelper_1.sleepAsync(10000)];
                case 7:
                    _a.sent();
                    recorder.stop('C:\\tmp\\chat\\outputtest_' + UniqueHelper_1.createUnique() + '.mp4');
                    console.log('DONE!!');
