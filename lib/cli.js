...
var FFmpegRecorder_1 = require("./services/FFmpegRecorder");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, ThreadingHelper_1.sleep(5000)];
                case 2:
                    _a.sent();
                    recorder.pause();
                    console.log('Paused');
                    return [4 /*yield*/, ThreadingHelper_1.sleep(2000)];
                case 3:
                    _a.sent();
                ...
                case 6:
                    _a.sent();
                    recorder.start();
                    return [4 /*yield*/, ThreadingHelper_1.sleep(10000)];
                case 7:
                    _a.sent();
                    recorder.stop('C:\\tmp\\chat\\outputtest_' + UniqueHelper_1.createUnique() + '.mp4');
                    console.log('DONE!!');
