        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        if (!TypeHelper_1.ofType(creator, CreatorWithSegmentLists)) return [3 /*break*/, 4];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        new FFmpegProcess_1.FFmpegProcess()
                            .startAsync(['-f', 'concat', '-i', mergedSegmentListFile, '-c', 'copy', filename], {
                            cwd: _this.cwd,
                        })
                            .then(function () { return setTimeout(function () { return resolve(filename); }, 500); })
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        new FFmpegProcess_1.FFmpegProcess()
                            ...
                            .then(function () { return setTimeout(function () { return resolve(outfile); }, 500); })
                            .catch(function (err) { return reject(err); });
                    })];
            });
        });
