...
exports.MediaFileCreator = exports.CreatorWithSegmentLists = exports.CreatorWithSegmentFiles = exports.CreatorWithRoot = void 0;
...
var CreatorWithRoot = /** @class */ (function () {
    function CreatorWithRoot(root) {
        this.root = root;
    }
    return CreatorWithRoot;
}());
exports.CreatorWithRoot = CreatorWithRoot;
var CreatorWithSegmentFiles = /** @class */ (function () {
    function CreatorWithSegmentFiles(segmentFiles) {
        this.segmentFiles = segmentFiles;
    }
    return CreatorWithSegmentFiles;
}());
exports.CreatorWithSegmentFiles = CreatorWithSegmentFiles;
var CreatorWithSegmentLists = /** @class */ (function () {
    function CreatorWithSegmentLists(segmentLists) {
        this.segmentLists = segmentLists;
    }
    return CreatorWithSegmentLists;
}());
exports.CreatorWithSegmentLists = CreatorWithSegmentLists;
var MediaFileCreator = /** @class */ (function () {
    ...
    MediaFileCreator.prototype.create = function (outfile, options) {
        return __awaiter(this, void 0, void 0, function () {
            var opt, creator, segmentListFiles, segmentFiles, segmentList, mergedSegmentListFile, concatenatedFile, convertedFile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        opt = __assign({ cwd: this.cwd, creator: new CreatorWithRoot(this.cwd) }, options);
                        creator = opt.creator;
                        if (!TypeHelper_1.ofType(creator, CreatorWithRoot)) return [3 /*break*/, 1];
                        segmentListFiles = this.findSegmentLists(creator.root);
                        if (segmentListFiles.length > 0) {
                            return [2 /*return*/, this.create(outfile, __assign(__assign({}, opt), { creator: new CreatorWithSegmentLists(segmentListFiles) }))];
                        }
                        segmentFiles = this.findSegmentFiles(creator.root);
                        if (segmentFiles.length > 0) {
                            return [2 /*return*/, this.create(outfile, __assign(__assign({}, opt), { creator: new CreatorWithSegmentFiles(segmentFiles) }))];
                        }
                        return [2 /*return*/, undefined];
                    case 1:
                        if (!TypeHelper_1.ofType(creator, CreatorWithSegmentFiles)) return [3 /*break*/, 2];
                        ...
                        return [2 /*return*/, this.create(outfile, __assign(__assign({}, opt), { creator: new CreatorWithSegmentLists([segmentList]) }))];
                    case 2:
                        if (!TypeHelper_1.ofType(creator, CreatorWithSegmentLists)) return [3 /*break*/, 5];
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.convert(concatenatedFile, outfile)];
                    case 4:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        var filename = "all_" + unique + ".ts";
                        var prc = new FFmpegProcess_1.FFmpegProcess();
                        prc.startAsync(['-f', 'concat', '-i', mergedSegmentListFile, '-c', 'copy', filename], {
                            cwd: _this.cwd,
                        })
                            .then(function () { return prc.killAsync(2000).then(function () { return resolve(filename); }); })
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        prc.startAsync(['-i', inputFile, '-acodec', 'copy', '-vcodec', 'copy', outfile], {
                            ...
                            .then(function () { return prc.killAsync(2000).then(function () { return resolve(outfile); }); })
                            .catch(function (err) { return reject(err); });
                    })];
            });
        });
