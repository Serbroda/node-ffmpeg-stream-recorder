    ...
    Recorder.prototype.recordForSession = function () {
        ...
        this._process.start([
            ...
            onExit: function (code, planned) {
                if (planned !== undefined && !planned) {
                    ...
                    if (_this._options
                        ...
                        _this._sessionInfo.retries <
                            _this._options
                                .retryTimesIfRecordingExitedAbnormally) {
                        _this._sessionInfo.retries = _this._sessionInfo
                            .retries++;
                        setTimeout(_this.recordForSession, 2000);
                    }
                ...
                else if (_this._sessionInfo.state === RecorderState_1.RecorderState.RECORDING) {
                    _this.setState(RecorderState_1.RecorderState.PAUSED);
                }
            },
        });
    };
