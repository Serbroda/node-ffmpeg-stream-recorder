...
var Recorder = /** @class */ (function () {
    ...
    Object.defineProperty(Recorder.prototype, "pid", {
        get: function () {
            var _a;
            return (_a = this._recorderProcess) === null || _a === void 0 ? void 0 : _a.pid;
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(Recorder.prototype, "lastOutFile", {
        get: function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    temp_1 = path.join((options === null || options === void 0 ? void 0 : options.workDirectory) || dir, name_1 + ".ts");
                                    if (!fs.existsSync(path.dirname(temp_1))) {
                                        fs.mkdirSync(path.dirname(temp_1));
                                    }
