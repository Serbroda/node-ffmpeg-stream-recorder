...
var Recorder = /** @class */ (function () {
    ...
    Recorder.prototype.stopSync = function (outfile, timeoutMillis) {
        this.stop(outfile);
        var counter = 0;
        var millis = timeoutMillis ? timeoutMillis / 10 : -1;
        while (this._sessionInfo.state !== RecorderState_1.RecorderState.COMPLETED && (millis < 1 || counter < millis)) {
            __1.sleep(10);
            counter++;
        }
    };
