...
exports.FFmpegRecorder = exports.defaultFFmpegRecorderOptions = exports.FFmpegRecorderState = void 0;
...
var FFmpegRecorder = /** @class */ (function () {
    function FFmpegRecorder(url, options) {
        this._id = Helpers_1.createUnique();
        this._url = url;
    ...
    FFmpegRecorder.prototype.setState = function (state) {
        ...
        if (this._options.onStateChange) {
            this._options.onStateChange(this._sessionInfo.state, state, this._sessionInfo);
        }
    ...
    FFmpegRecorder.prototype.isBusy = function () {
        ...
        return (this._sessionInfo.state !== FFmpegRecorderState.INITIAL &&
    ...
    FFmpegRecorder.prototype.sessionSegmentLists = function () {
        ...
        return Helpers_1.findFiles(this._currentWorkingDirectory, new RegExp("seglist_" + this._sessionInfo.unique + "_\\d*\\.txt"));
    };
    FFmpegRecorder.prototype.sessionSegmentFiles = function () {
        if (!this._currentWorkingDirectory) {
            return [];
        }
        return Helpers_1.findFiles(this._currentWorkingDirectory, new RegExp("seg_" + this._sessionInfo.unique + "_\\d*_\\d*\\.ts"));
    };
    FFmpegRecorder.prototype.start = function () {
        ...
        if (this._sessionInfo.state != FFmpegRecorderState.PAUSED) {
            this._sessionInfo.unique = Helpers_1.createUnique();
    ...
    FFmpegRecorder.prototype.stop = function (outfile) {
        ...
        if (out) {
            ...
            this.createOutputFile(out, function () {
                ...
                _this.setState(FFmpegRecorderState.FINISH);
            });
        }
        else {
    ...
    FFmpegRecorder.prototype.recordForSession = function () {
        ...
        this._process.start([
            ...
            onExit: function (code) {
                if (_this._sessionInfo.state == FFmpegRecorderState.RECORDING) {
                    console.warn('Process exited abnormally');
                    _this.setState(FFmpegRecorderState.PAUSED);
                }
            },
        });
    ...
    FFmpegRecorder.prototype.mergeSegmentLists = function () {
        ...
        if (!segLists || segLists.length == 0) {
            ...
            var status_1 = Helpers_1.mergeFiles(segLists, mergedOutFile);
