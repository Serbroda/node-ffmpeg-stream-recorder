...
var StreamRecorder = /** @class */ (function () {
    ...
    StreamRecorder.prototype.getSessionSegmentLists = function () {
        ...
        return FileHelper_1.findFiles(this._cwd, new RegExp("seglist_" + this._sessionInfo.sessionUnique + "_\\d*\\.txt"));
    };
    /**
    ...
    StreamRecorder.prototype.getSessionSegmentFiles = function () {
        ...
        return FileHelper_1.findFiles(this._cwd, new RegExp("seg_" + this._sessionInfo.sessionUnique + "_\\d*_\\d*\\.ts"));
    };
    /**
    ...
    StreamRecorder.prototype.stop = function (outfile, onStoppedFinish) {
        ...
        if (!this.outFile) {
            this.outFile = path_1.join(this.options.cwd, this.sessionInfo.sessionUnique + '.mp4');
        }
        if (onStoppedFinish) {
    ...
    StreamRecorder.prototype.startNewSession = function () {
        ...
        var workDir = this._options.cwd ? this._options.cwd : __dirname;
        if (!fs.existsSync(workDir)) {
            this.setState(RecorderState_1.RecorderState.ERROR);
            throw new Error("Working directory '" + workDir + "' does not exist!");
        }
        this._cwd = path_1.join(workDir, this._sessionInfo.sessionUnique);
    ...
    StreamRecorder.prototype.recordForSession = function () {
        ...
        this._fileWatcher = fs.watch(this._cwd, function (eventType, filename) {
            if (eventType === 'rename' &&
    ...
    StreamRecorder.prototype.createOutputFile = function (outfile) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new MediaFileCreator_1.MediaFileCreator(this._cwd).create(outfile)];
            });
        });
    };
    StreamRecorder.prototype.cleanWorkingDirectory = function () {
        ...
        setTimeout(function () {
            FileHelper_1.deleteFolderRecursive(_this._cwd, false);
        }, 1000);
    };
