...
var StreamRecorder = /** @class */ (function () {
    ...
    StreamRecorder.prototype.startNewSession = function () {
        this._process = new FFmpegProcess_1.FFmpegProcess(this.options.ffmpegExecutable);
    ...
    StreamRecorder.prototype.createOutputFile = function (outfile, onProcessFinish) {
        var _this = this;
        ...
        new FFmpegProcess_1.FFmpegProcess(this.options.ffmpegExecutable)
            .startAsync(args, {
            cwd: this._currentWorkingDirectory,
        })
            .then(function (result) {
            if (allTsFile) {
                new FFmpegProcess_1.FFmpegProcess(_this.options.ffmpegExecutable)
                    .startAsync(['-i', allTsFile, '-acodec', 'copy', '-vcodec', 'copy', outfile], {
                    cwd: _this._currentWorkingDirectory,
                })
                    .then(function () { return onProcessFinish(); });
            }
            else {
                onProcessFinish();
            }
    ...
    StreamRecorder.prototype.mergeSegmentLists = function () {
