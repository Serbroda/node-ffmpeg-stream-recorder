...
var StreamRecorder = /** @class */ (function () {
    ...
    StreamRecorder.prototype.stop = function (finish) {
        ...
        this._process.killAsync(5000).then(function () {
            if (finish) {
                _this.finish();
            }
        });
    ...
    StreamRecorder.prototype.record = function () {
        var _this = this;
        ...
        this._process.start([
            ...
            onExitAbnormally: function (result) {
                var stateBeforeExit = _this._sessionInfo.state;
                if (stateBeforeExit === RecorderState_1.RecorderState.RECORDING) {
                    if (_this._options.retry > 0 && _this._sessionInfo.retries < _this._options.retry) {
