...
var StreamRecorder = /** @class */ (function () {
        ...
        if (typeof param1 === 'string') {
            ...
            this._sessionInfo = {
                ...
                state: this._options.cwd && fs.existsSync(this._options.cwd)
                    ? RecorderState_1.RecorderState.PAUSED
                    : RecorderState_1.RecorderState.INITIAL,
                segmentUnique: UniqueHelper_1.createUnique(),
                retries: 0,
            };
        }
        else {
            ...
            this._options = __assign(__assign({}, param1.options), options);
            this._sessionInfo = param1.sessionInfo;
            this._sessionInfo = __assign(__assign({}, param1.sessionInfo), {
                state: RecorderState_1.RecorderState.PAUSED,
                segmentUnique: UniqueHelper_1.createUnique(),
            });
        }
    ...
    StreamRecorder.prototype.setState = function (state) {
        ...
        if (state === RecorderState_1.RecorderState.PROCESS_EXITED_ABNORMALLY) {
    ...
    StreamRecorder.prototype.getSessionSegmentLists = function () {
        ...
        return FileHelper_1.findFiles(this._options.cwd, new RegExp("seglist_" + this._sessionInfo.sessionUnique + "_\\d*\\.txt"));
    };
    /**
    ...
    StreamRecorder.prototype.getSessionSegmentFiles = function () {
        ...
        return FileHelper_1.findFiles(this._options.cwd, new RegExp("seg_" + this._sessionInfo.sessionUnique + "_\\d*_\\d*\\.ts"));
    };
    /**
    ...
    StreamRecorder.prototype.start = function () {
        ...
        this._sessionInfo.segmentUnique = UniqueHelper_1.createUnique();
     ...
     */
    StreamRecorder.prototype.stop = function (outfile, onStoppedFinish) {
    ...
    StreamRecorder.prototype.startNewSession = function () {
        ...
        var workDir = this._options.workDir;
    ...
    StreamRecorder.prototype.finish = function () {
        ...
        var dir = path.dirname(this.outFile);
        ...
        this._process.start([
            ...
            onExit: function (result) {
                if (!result.plannedKill) {
                    ...
                    if (_this._options.retry &&
                        _this._options.retry > 0 &&
                        _this._sessionInfo.retries < _this._options.retry) {
    ...
    StreamRecorder.prototype.createOutputFile = function (outfile) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new MediaFileCreator_1.MediaFileCreator(this._options.cwd).create(outfile)];
            });
        });
    };
