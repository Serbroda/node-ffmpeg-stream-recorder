...
var FFmpegProcess = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var originalOnExit = options === null || options === void 0 ? void 0 : options.onExit;
                        try {
                            _this.start(args, __assign(__assign({}, options), { onExit: function (result) {
                                    if (originalOnExit) {
    ...
    FFmpegProcess.prototype.killAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.kill();
                        var killed = _this.waitForProcessKilled(2000);
                        if (killed) {
                            resolve();
                        }
                        else {
