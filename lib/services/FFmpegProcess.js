...
var FFmpegProcess = /** @class */ (function () {
    function FFmpegProcess(_executable) {
        if (_executable === void 0) { _executable = 'ffmpeg'; }
    ...
    FFmpegProcess.prototype.start = function (args, options) {
        ...
        var cwd = (options === null || options === void 0 ? void 0 : options.cwd) ? options.cwd : __dirname;
        if (options) {
            if (options.onExit) {
        ...
        this._childProcess.on('close', function (code, signal) {
            ...
            _this._onExitEvent.trigger(result);
