...
var FFmpegProcess = /** @class */ (function () {
    function FFmpegProcess() {
        ...
        this._checkExitContinuouslyTimeout = 30000;
    ...
    FFmpegProcess.prototype.start = function (args, options) {
        ...
        var checkExit = opt.checkExitContinuously !== undefined ? opt.checkExitContinuously : false;
        ...
        if (checkExit) {
            this._checkExitContinuouslyInterval = setInterval(function () {
                if (!_this.isRunning()) {
                    if (!_this._exitHandled) {
                        _this.handleExit(-99, 'SIGINT', opt);
                    }
                    clearInterval(_this._checkExitContinuouslyInterval);
                }
            }, this._checkExitContinuouslyTimeout);
        }
        this._childProcess.once('close', function (code, signal) {
            _this.handleExit(code, signal, opt);
        });
    };
    ...
    FFmpegProcess.prototype.handleExit = function (exitCode, signal, options) {
