...
var RecorderManager = /** @class */ (function () {
    ...
    RecorderManager.prototype.create = function (request, onStateChange) {
        ...
        var recorderOptions = this
            ._options;
        var autocreateOutputInSemaphore = this.isUseSemaphore &&
        ...
        recorderOptions.onStateChange = function (newState, oldState, sessionInfo) {
            if (sessionInfo) {
                if (_this.recorders[sessionInfo.recorderId]) {
                    ...
                    if (newState == models_1.RecorderState.PROCESS_EXITED_ABNORMALLY &&
                        autocreateOutputInSemaphore) {
                        _this.stop(_this.recorders[sessionInfo.recorderId].request);
                    }
                    else if (newState == models_1.RecorderState.COMPLETED &&
                        _this._options.autoRemoveWhenFinished) {
                        if (_this._options.printMessages) {
